...
def notification_rd(title=None, message=None, icon=None, time=3000, sound=False):
	...
	dialog.notification(heading, body, icon, time, sound=sound)
	xbmc.sleep(5000)
	xbmc.executebuiltin('RunScript(script.module.myaccts, action=realdebridSync)')
...
def notification_pm(title=None, message=None, icon=None, time=3000, sound=False):
	...
	dialog.notification(heading, body, icon, time, sound=sound)
	xbmc.sleep(5000)
	xbmc.executebuiltin('RunScript(script.module.myaccts, action=premiumizeSync)')
...
def notification_ad(title=None, message=None, icon=None, time=3000, sound=False):
	...
	dialog.notification(heading, body, icon, time, sound=sound)
	xbmc.sleep(5000)
	xbmc.executebuiltin('RunScript(script.module.myaccts, action=alldebridSync)')
	notification('AllDebrid', 'Sync in progress, please wait!', icon=ad_icon)
	xbmc.sleep(5000)
