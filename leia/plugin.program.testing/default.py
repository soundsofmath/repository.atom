...
base='YOURWIZARDNAME'
ADDON=xbmcaddon.Addon(id='plugin.program.testing')
...
EXCLUDES     = ['plugin.program.testing']
...
def wizard(name,url,description):
    ...
    dp = xbmcgui.DialogProgress()
    dp.create("Testing Wizard","Wizard is Whizzing down your Wires ",'', 'Put the kettle on')
