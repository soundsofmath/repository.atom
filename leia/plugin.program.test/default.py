...
base='YOURWIZARDNAME'
ADDON=xbmcaddon.Addon(id='plugin.program.YOURNAME')
    
    
VERSION = "1.0.1"


PATH = "Your Wizard Name"            

dp           =  xbmcgui.DialogProgress()
dialog       =  xbmcgui.Dialog()
EXCLUDES     = ['plugin.program.YOURNAME']
HOME         =  xbmc.translatePath('special://home/')

    
def CATEGORIES():
    link = OPEN_URL('https://raw.githubusercontent.com/soundsofmath/repository.atom/master/wizard.txt').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp = xbmcgui.DialogProgress()
    dp.create("YOUR WIZARD NAME","Wizard is Whizzing down your Wires ",'', 'Put the kettle on')
...
def FRESHSTART(params):
    ...
    choice2 = xbmcgui.Dialog().yesno("Are you sure?", 'Are you sure you want to wipe this install?', '', 'All addons EXCLUDING YOUR WIZARD NAME will be completely wiped!', yeslabel='Yes',nolabel='No')
    if choice2 == 0:
        return
    elif choice2 == 1:
