...
ADDONTITLE     = '[B][COLOR white]**[COLOR blue]Magnetic Wizard[COLOR white]**[/COLOR][/B]'
BUILDERNAME    = 'Magnetic Wizard'
#########################Make sure to change the repo to yours!!!!
EXCLUDES       = [ADDON_ID, '', 'My_Builds', 'backupdir']
BUILDFILE      = 'https://raw.githubusercontent.com/soundsofmath/repository.atom/master/autobuilds.txt'
UPDATECHECK    = 0
APKFILE        = 'http://magnetic.website/wizard/Text/apk.txt'
YOUTUBETITLE   = 'http://'
YOUTUBEFILE    = 'http://'
ADDONFILE      = 'http://'
ADVANCEDFILE   = 'http://'
...
WIZTITLE = 'Magnetic Wizard'
WIZTITLE_COLOR = 'blue'
VERTITLE_COLOR = 'white'
VER_NUMBER_COLOR = 'blue'
############################################################
...
HIDECONTACT    = 'No'
# You can add \n to do line breaks
CONTACT        = 'Thank you for choosing Magnetic Wizard.'
#Images used for the contact window.  http:// for default icon and fanart
CONTACTICON    = os.path.join(ART, 'icon.png')
CONTACTFANART  = 'https://raw.githubusercontent.com/soundsofmath/repository.atom/master/fanart.jpg'
#########################################################
...
WIZARDFILE     = 'https://raw.githubusercontent.com/soundsofmath/repository.atom/master/autobuilds.txt'
#########################################################
...
NOTIFICATION   = 'https://raw.githubusercontent.com/soundsofmath/repository.atom/master/notify.txt'
# Use either 'Text' or 'Image'
HEADERTYPE     = 'Text'
# Font size of header
FONTHEADER     = 'Font25'
HEADERMESSAGE  = 'Magnetic Wizard'
# url to image if using Image 424x180
HEADERIMAGE    = ''
# Font for Notification Window
FONTSETTINGS   = 'Font12'
# Background for Notification Window
BACKGROUND     = 'https://raw.githubusercontent.com/soundsofmath/repository.atom/master/fanart.jpg'
############################    #############################