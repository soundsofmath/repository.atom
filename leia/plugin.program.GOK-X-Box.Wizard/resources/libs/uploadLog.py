	...
	def __init__(self):
		...
		for item in files:
			...
			if succes:
				...
				if succes:
					msg = "Poste diese URL oder scanne den QRcode fur dein [COLOR %s]%s[/COLOR], zusammen mit einer Beschreibung deines Problems:[CR][COLOR %s]%s[/COLOR]" % (COLOR1, name, COLOR1, result)
					if len(self.email) > 5: 
