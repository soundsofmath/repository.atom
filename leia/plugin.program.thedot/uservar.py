...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR white][B]The[/B][/COLOR]Dot'
BUILDERNAME = 'Wizard'
EXCLUDES = [ADDON_ID, 'plugin.program.thedot']
...
HIDECONTACT = 'No'
# You can add \n to do line breaks
CONTACT = 'Thank you for choosing TheDot.\n\nContact us on Github at http://www.github.com/drinfernoo/plugin.program.thedot/'
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR white][B]The[/B][/COLOR]Dot'
