...
dyn = xmls + translatePath('plugin.video.dynasty/settings.xml')
...
thelabjr = xmls + translatePath('plugin.video.thelabjr/settings.xml')
...
chk_dyn = addons + translatePath('plugin.video.dynasty/')
...
chk_thelabjr = addons + translatePath('plugin.video.thelabjr/')
...
dyn_ud = addon_data + translatePath('plugin.video.dynasty/')
...
thelabjr_ud = addon_data + translatePath('plugin.video.thelabjr/')
...
chkset_dyn = addon_data + translatePath('plugin.video.dynasty/settings.xml')
...
chkset_thelabjr = addon_data + translatePath('plugin.video.thelabjr/settings.xml')
...
path_thelabjr = addons + translatePath('plugin.video.thelabjr/resources/lib/modules/trakt.py')
...
thelabjr_client = 'c0f8e1164003c7117d60713756a1812250e13f64d194d432057246e6867adf8f'
thelabjr_secret = 'cf70a427f74b8ed7349717405e723f021be6d67aa709207ad7242c4d1740830c'
