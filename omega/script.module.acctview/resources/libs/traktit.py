...
TRAKTID = {
   'seren': {
    ...
    'dynasty': {
        ...
        'file'     : os.path.join(CONFIG.TRAKTFOLD, 'dynasty_trakt'),
    ...
    'thelabjr': {
        ...
        'icon'     : os.path.join(CONFIG.ADDONS, 'plugin.video.thelabjr/resources/media/TheLabJr', 'icon.png'),
        'fanart'   : os.path.join(CONFIG.ADDONS, 'plugin.video.thelabjr/resources/media/TheLabJr', 'fanart.jpg'),
