...
class sources:
    ...
    def getConstants(self):
        self.itemProperty = 'plugin.video.absolution.container.items'

        self.metaProperty = 'plugin.video.absolution.container.meta'
        ...
        self.module_name = 'absolution:'

        if externalEnabled == 'true':
            try:
                import absolutionscrapers
                self.sourceDict += absolutionscrapers.sources()
                self.module_name = 'absolutionScrapers (' + str(control.addon('script.module.absolutionscrapers').getSetting('package.folder')) + ' set):' \
                                   if control.addon('script.module.absolutionscrapers').getSetting('package.folder') != 'absolutionscrapers' else '[COLOR white]absolution will find your content[/COLOR]'
            except:
                pass
