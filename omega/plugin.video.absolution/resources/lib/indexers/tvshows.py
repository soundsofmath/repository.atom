...
class tvshows:
    def __init__(self):
        ...
        self.popular_link = 'https://api.trakt.tv/shows/favorited/weekly?limit=%s&page=1' % self.items_per_page
        ...
        #self.premiere_link = 'https://api.themoviedb.org/3/discover/tv?api_key=74f3ce931d65ebda1f77ef24eac2625f&sort_by=popularity.desc&with_watch_providers=%25s&watch_region=%25s&page=1'
        self.rating_link = 'https://api.trakt.tv/shows/popular?limit=%s&page=1' % self.items_per_page
        self.views_link = 'https://api.themoviedb.org/3/discover/tv?api_key=74f3ce931d65ebda1f77ef24eac2625f&sort_by=popularity.desc&with_watch_providers=%25s&watch_region=%25s&page=1'
