...
class navigator:
    def root(self):
        ...
        self.addDirectoryItem('[COLORteal]New Releases[/COLOR]', 'oneclick', 'oneshot.png', 'DefaultMovies.png')
    ...
    def movies(self, lite=False):
        ...
        self.addDirectoryItem(32022, 'movies&url=theaters', 'highly-rated.png', 'DefaultRecentlyAddedMovies.png')
    ...
    def tools(self):
        self.addDirectoryItem('[B]Absolution[/B] : Changelog', 'changelog', 'tools.png', 'DefaultAddonProgram.png', isFolder=False)
        self.addDirectoryItem(32043, 'openSettings&query=0.0', 'tools.png', 'DefaultAddonProgram.png', isFolder=False)
        self.addDirectoryItem(32079, 'absolutionscrapersettings', 'icon.png', 'DefaultAddonProgram.png', isFolder=False)
        ...
        self.addDirectoryItem('[B]Absolution[/B] : Cache Functions', 'cacheNavigator', 'tools.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem('[B]Absolution[/B] : Log Functions', 'logNavigator', 'tools.png', 'DefaultAddonProgram.png')
    ...
    def log_functions(self):
        self.addDirectoryItem('[B]Absolution[/B] : View Log', 'viewLog', 'tools.png', 'DefaultAddonProgram.png', isFolder=False)
        self.addDirectoryItem('[B]Absolution[/B] : Upload Log to Pastebin', 'uploadLog', 'tools.png', 'DefaultAddonProgram.png', isFolder=False)
        self.addDirectoryItem('[B]Absolution[/B] : Empty Log', 'emptyLog', 'tools.png', 'DefaultAddonProgram.png', isFolder=False)
