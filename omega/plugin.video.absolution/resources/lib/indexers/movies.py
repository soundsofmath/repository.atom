...
class movies:
    def __init__(self):
        ...
        self.theaters_link = 'https://api.themoviedb.org/3/discover/movie?api_key=74f3ce931d65ebda1f77ef24eac2625f&sort_by=popularity.desc&with_watch_providers=%25s&watch_region=%25s&page=1'
        ...
        self.boxoffice_link = 'https://api.trakt.tv/movies/boxoffice?limit=%s&page=1' % self.items_per_page
    ...
    def custom_lists(self):
        lists = [('ls093264464', 'Netflix - All Movies'),
				 ...
				 ('ls093298670', 'HBO - All Movies'),
				 ('ls093287394', 'Prime Video - All Movies Pt.2'),
				 ('ls093295519', 'Prime Video - All Movies Pt.1'),
				 ('ls093298636', 'Disney+ - All Movies'),
				 ('ls093298387', 'Hulu - All Movies'),
				 ('ls093287916', 'Prime Video - All TV Shows'),
				 ('ls093287909', 'Netflix - All TV Shows'),
				 ('ls093287496', 'Hulu - All TV Shows'),
				 ('ls093287428', 'HBO - All TV Shows'),
				 ('ls093287435', 'Disney+ - All TV Shows'),
