...
class source:
	...
	def __init__(self):
		self.addon = xbmcaddon.Addon('plugin.video.genesis')
		self.priority = 1
		...
		self.key = 'VWxOQk1FbEZXV2RQVTBKT1NVVlJaMUpwUWtWSlJsRm5WWGxDVGtsRk5HZFVRMEpVU1VWRlowNURRVFJKUlhkblVtbENWVWxGWjJkU2FVSkxTVVZqWjFORFFrbEpSVTFuVDFOQ1NFbEZiMmRUYVVKRw=='
	...
	def _error(self):
		...
		xbmc.log('GENESIS ORION [ERROR]: ' + parameters, xbmc.LOGERROR)
