...
class orionoid(Scraper):
	...
	Keys = {
		'default' : 'VWtOQ1IwbEZXV2RWYVVKUlNVWkZaMUY1UVRCSlJrVm5WR2xDUWtsRWEyZFRhVUV3U1VVMFoxUkRRa2hKUlRSblZXbENVa2xGWjJkUFUwSkRTVVpaWjFOcFFrMUpSVWxuVTJsQ1ZFbEZZMmRSYVVKTA==',
	}

	def __init__(self):
		self.addon = xbmcaddon.Addon('script.module.nanscrapers')
