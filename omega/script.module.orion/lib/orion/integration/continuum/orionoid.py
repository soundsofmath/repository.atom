...
class source:
	...
	def __init__(self):
		self.addon = xbmcaddon.Addon('plugin.video.cmovies')
		self.priority = 1
		...
		self.key = 'VjBOQ1dFbEZSV2RPYVVFd1NVVk5aMUpwUVRGSlJXZG5VME5CTlVsRWEyZFZhVUpWU1VSVloxRjVRa1ZKUkVsblZVTkNSVWxGZDJkVVEwSklTVVZ6WjFSRFFrbEpSa2xuVTJsQ1JVbEVaMmRWVTBKTQ=='
	...
	def _error(self):
		...
		xbmc.log('CONTINUUM ORION [ERROR]: ' + parameters, xbmc.LOGERROR)
