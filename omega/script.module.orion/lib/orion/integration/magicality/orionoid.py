...
class source:
	...
	def __init__(self):
		self.addon = xbmcaddon.Addon('plugin.video.magicality')
		self.priority = 1
		...
		self.key = 'VTBOQ1RFbEdRV2RQUTBKSlNVVnZaMVJUUWtOSlJWRm5VbmxDUlVsRk1HZFJhVUpGU1VWUloxWjVRa1pKUlRSblZGTkNURWxGVVdkVVEwSkpTVVZ6WjFWVFFsaEpSVWxuVldsQk0wbEZiMmRWVTBKVA=='
	...
	def _error(self):
		...
		xbmc.log('MAGICALITY ORION [ERROR]: ' + parameters, xbmc.LOGERROR)
