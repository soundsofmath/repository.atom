...
class source:
	...
	Keys = {
		'default' : 'VTJsQ1RrbEZiMmRTZVVKUFNVVTBaMU5EUWtSSlJsRm5VM2xDUjBsRlkyZE9RMEpQU1VVMFoxSkRRa3hKUlVWblVtbEJNMGxGZDJkU1EwSkhTVVJyWjFGVFFrWkpSV2RuVW1sQ1MwbEZkMmRTYVVFMQ==',
		'plugin.video.nightwing' : 'VW5sQ1QwbEdRV2RQVTBKVVNVVkpaMUo1UWtSSlJrRm5WRU5DUWtsRVkyZFNVMEpIU1VWTloxTjVRa2hKUkdkblVXbENUa2xFU1dkT2VVRXpTVVZuWjFONVFrZEpSVWxuVTNsQk1VbEZVV2RSZVVKRA==',
	}

	def __init__(self):
		self.addon = xbmcaddon.Addon('script.module.nightwingscrapers')
	...
	def _error(self):
		...
		xbmc.log('NIGHTWING SCRAPERS ORION [ERROR]: ' + parameters, xbmc.LOGERROR)
	...
	def sources(self, url, hostDict, hostprDict):
		...
		try:
			...
			data = OrionTools.urlParseQs(url, single = True)
			...
			results = orion.streams(
				...
				streamType = orion.streamTypes([Orion.StreamTorrent, Orion.StreamHoster]),
