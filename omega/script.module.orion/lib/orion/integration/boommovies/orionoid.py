...
class source:
	...
	def __init__(self):
		self.addon = xbmcaddon.Addon('plugin.video.BoomMovies')
		self.priority = 1
		...
		self.key = 'VkdsQ1NVbEZVV2RTUTBKSFNVVjNaMVZwUWt0SlJWRm5WWGxDUTBsRlRXZFNlVUpSU1VVMFoxVnBRa2xKUldkblZVTkNSRWxGWTJkVlEwSkhTVVZuWjFONVFsZEpSbXRuVWtOQ1VVbEZSV2RQVTBKTA=='
	...
	def _error(self):
		...
		xbmc.log('BOOM ORION [ERROR]: ' + parameters, xbmc.LOGERROR)
