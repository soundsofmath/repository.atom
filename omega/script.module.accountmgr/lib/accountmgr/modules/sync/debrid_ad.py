...
#Seren AD
    ...
    #Dynasty AD
        try:
                if xbmcvfs.exists(var.chk_umb) and xbmcvfs.exists(var.chkset_umb):
                        chk_auth_umb = xbmcaddon.Addon('plugin.video.dynasty').getSetting("alldebridtoken")
                        chk_auth_umb_rd = xbmcaddon.Addon('plugin.video.dynasty').getSetting("realdebridtoken")
                ...
                xbmc.log('%s: Dynasty All-Debrid Failed!' % var.amgr, xbmc.LOGINFO)
                pass
