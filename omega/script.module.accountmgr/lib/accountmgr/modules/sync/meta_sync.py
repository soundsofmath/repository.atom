        ...
        #Dynasty
                try:
                        if xbmcvfs.exists(var.chk_umb) and xbmcvfs.exists(var.chkset_umb):
                                ...
                                chk_fanart_api = xbmcaddon.Addon('plugin.video.dynasty').getSetting("fanart_tv.api_key")
                                chk_mdb_api = xbmcaddon.Addon('plugin.video.dynasty').getSetting("mdblist.api")
                                chk_imdb_api = xbmcaddon.Addon('plugin.video.dynasty').getSetting("imdbuser")    
                                chk_tmdb_api = xbmcaddon.Addon('plugin.video.dynasty').getSetting("tmdb.apikey")
                                chk_tmdb_user = xbmcaddon.Addon('plugin.video.dynasty').getSetting("tmdbusername")
                                chk_tmdb_pass = xbmcaddon.Addon('plugin.video.dynasty').getSetting("tmdbpassword")
                                chk_tmdb_session = xbmcaddon.Addon('plugin.video.dynasty').getSetting("tmdb.sessionid")
                        ...
                        xbmc.log('%s: Dynasty Metadata Failed!' % var.amgr, xbmc.LOGINFO)
                        pass
