...
class Auth:
    ...
    #Dynasty RD
        try:
                if xbmcvfs.exists(var.chk_umb) and xbmcvfs.exists(var.chkset_umb):
                        chk_auth_umb = xbmcaddon.Addon('plugin.video.dynasty').getSetting("realdebridtoken")
                        chk_auth_umb_pm = xbmcaddon.Addon('plugin.video.dynasty').getSetting("premiumizetoken")
                        chk_auth_umb_ad = xbmcaddon.Addon('plugin.video.dynasty').getSetting("alldebridtoken")
                        if not str(var.chk_accountmgr_tk_rd) == str(chk_auth_umb) or str(chk_auth_umb) == '':
                ...
                xbmc.log('%s: Dynasty Real-Debrid Failed!' % var.amgr, xbmc.LOGINFO)
                pass
