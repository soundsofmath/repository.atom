...
class navigator:
    def root(self):
        ...
        self.addDirectoryItem('Homelander', 'oneclick', 'icon.png', 'DefaultMovies.png')
    ...
    def tools(self):
        self.addDirectoryItem('[B]Homelander[/B] : Changelog', 'changelog', 'tools.png', 'DefaultAddonProgram.png', isFolder=False)
        ...
        self.addDirectoryItem('[B]Homelander[/B] : Cache Functions', 'cacheNavigator', 'tools.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem('[B]Homelander[/B] : Log Functions', 'logNavigator', 'tools.png', 'DefaultAddonProgram.png')
    ...
    def log_functions(self):
        self.addDirectoryItem('[B]Homelander[/B] : View Log', 'viewLog', 'tools.png', 'DefaultAddonProgram.png', isFolder=False)
        self.addDirectoryItem('[B]Homelander[/B] : Upload Log to Pastebin', 'uploadLog', 'tools.png', 'DefaultAddonProgram.png', isFolder=False)
        self.addDirectoryItem('[B]Homelander[/B] : Empty Log', 'emptyLog', 'tools.png', 'DefaultAddonProgram.png', isFolder=False)
