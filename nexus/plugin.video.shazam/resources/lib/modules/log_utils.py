...
DEBUGPREFIX = '[ Shazam {0} | {1} | {2} | DEBUG ]'.format(version, kodi_version, sys_platform)
INFOPREFIX = '[ Shazam | INFO ]'
...
def log(msg, trace=0):
    ...
    try:
        ...
        try:
            xbmc.log('Shazam Logging Failure: %s' % e, LOGDEBUG)
        except:
            pass
