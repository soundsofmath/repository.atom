...
if not ROOT:
    ROOT = 'special://profile/addon_data/plugin.program.fav/'
...
def verifyLocation():
    ...
    profile  = 'special://profile/addon_data/plugin.program.fav/'
    userdata = 'special://userdata/addon_data/plugin.program.fav/'
...
def WriteKeymap(start, end):
    filename = KEYMAP_HOT
    cmd      = 'RunScript(special://home/addons/plugin.program.fav/hot.py)'
